...
// -----------------------------------------
//
// Source: Broderamera.java
// Date  : 11 Feb 2017 19:38:28 ECT
 ...
 * Automatically generated load test program.
 */
public class Broderamera extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "BroderameraExtParams.dat";           // input file name for very large parameter values
	 ...
	 */
	public Broderamera(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	private boolean execute(int totalLoopCounter) throws Exception
	{
		...
		log();
		log();
		log("# Page #2: My second page break");
		log("# -----------------------------");
		threadStep = setPageBreak(performanceData, threadStep, "Page #2: My second page break", 3000, 35, -1);		// hint: param #4 is the user's think time in milliseconds, param #5 is randomness of the user's think time in percent (+/- 0..100%), param #6 is the maximum acceptable response time in milliseconds (-1 = not configured)
		pageThreadHandler = new HttpTestURLThreadHandler(threadStep - 1, maxParallelThreadsPerUser, performanceData, this);   // support for parallel processing of http(s) requests within a page. hint: param #2 is the number of parallel threads per user
		log();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0002 = "127.0.0.1";
		int    requestPort0002 = 7990;
		String requestFile0002 = "/dfischer/webadmininterface/BrowserExtensionWeblet" +
				"?action=getRecordState";
		...
		String requestHost0003 = "broderamera.nu";
		...
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {301}, null, null, null);		// Test [3] <- Index 3
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0004 = "detectportal.firefox.com";
		int    requestPort0004 = 80;
		String requestFile0004 = "/success.txt";
		...
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/PLAIN", null, null);		// Test [4] <- Index 4
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0005 = "detectportal.firefox.com";
		int    requestPort0005 = 80;
		String requestFile0005 = "/success.txt";
		...
		// verify response: status code = 200, content type = "TEXT/PLAIN", header text fragment = [verification disabled], recorded content size = 8
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/PLAIN", null, null);		// Test [5] <- Index 5
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0007 = "127.0.0.1";
		int    requestPort0007 = 7990;
		String requestFile0007 = "/dfischer/webadmininterface/BrowserExtensionWeblet" +
				"?action=getRecordState";
		...
		log();
		log("# title: Brodera Mera | Broderimaterial");
		String requestProt0008 = "https";
		String requestHost0008 = "broderamera.nu";
		...
		// verify response: status code = 200, content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 21023
		// content test algorithm: none - no content check
		...
		String requestHost0009 = "broderamera.nu";
		int    requestPort0009 = 443;
		String requestFile0009 = "/wp-includes/js/comment-reply.min.js" +
				"?ver=4.6.3";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 1078
		// content test algorithm: none - no content check
		...
		String requestHost0010 = "broderamera.nu";
		int    requestPort0010 = 443;
		String requestFile0010 = "/wp-content/themes/Divi/js/jquery.fitvids.js" +
				"?ver=2.3.1";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 2943
		// content test algorithm: none - no content check
		...
		String requestHost0011 = "broderamera.nu";
		int    requestPort0011 = 443;
		String requestFile0011 = "/wp-content/themes/Divi/epanel/shortcodes/css/shortcodes_responsive.css" +
				"?ver=3.0";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 4042
		// content test algorithm: none - no content check
		...
		String requestHost0012 = "broderamera.nu";
		int    requestPort0012 = 443;
		String requestFile0012 = "/wp-content/themes/Divi/epanel/shortcodes/css/shortcodes.css" +
				"?ver=3.0";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 36253
		// content test algorithm: none - no content check
		...
		String requestHost0013 = "broderamera.nu";
		int    requestPort0013 = 443;
		String requestFile0013 = "/wp-includes/js/jquery/jquery.js" +
				"?ver=1.12.4";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 97184
		// content test algorithm: none - no content check
		...
		String requestHost0014 = "broderamera.nu";
		int    requestPort0014 = 443;
		String requestFile0014 = "/wp-content/themes/Divi/style.css" +
				"?ver=2.3.1";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 302879
		// content test algorithm: none - no content check
		...
		String requestHost0015 = "broderamera.nu";
		int    requestPort0015 = 443;
		String requestFile0015 = "/wp-includes/js/jquery/jquery-migrate.min.js" +
				"?ver=1.4.1";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 10056
		// content test algorithm: none - no content check
		...
		String requestHost0016 = "detectportal.firefox.com";
		int    requestPort0016 = 80;
		String requestFile0016 = "/success.txt";
		...
		String requestHost0017 = "broderamera.nu";
		int    requestPort0017 = 443;
		String requestFile0017 = "/wp-content/themes/Divi/js/waypoints.min.js" +
				"?ver=2.3.1";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 8051
		// content test algorithm: none - no content check
		...
		String requestHost0018 = "broderamera.nu";
		int    requestPort0018 = 443;
		String requestFile0018 = "/wp-content/themes/Divi/js/custom.js" +
				"?ver=2.3.1";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 101009
		// content test algorithm: none - no content check
		...
		String requestHost0019 = "broderamera.nu";
		int    requestPort0019 = 443;
		String requestFile0019 = "/wp-content/themes/Divi/js/jquery.magnific-popup.js" +
				"?ver=2.3.1";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 47718
		// content test algorithm: none - no content check
		...
		String requestHost0020 = "broderamera.nu";
		int    requestPort0020 = 443;
		String requestFile0020 = "/wp-includes/js/wp-emoji-release.min.js" +
				"?ver=4.6.3";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 10414
		// content test algorithm: none - no content check
	...
	boolean executePage_1_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0021 = "broderamera.nu";
		int    requestPort0021 = 443;
		String requestFile0021 = "/wp-includes/js/wp-embed.min.js" +
				"?ver=4.6.3";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 1403
		// content test algorithm: none - no content check
		...
		String requestHost0022 = "broderamera.nu";
		int    requestPort0022 = 443;
		String requestFile0022 = "/wp-content/uploads/2015/07/BroderaMeraloggarakr%C3%B6d.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 48068
		// content test algorithm: none - no content check
		...
		String requestHost0023 = "broderamera.nu";
		int    requestPort0023 = 443;
		String requestFile0023 = "/wp-content/uploads/2016/05/Zickermankuddedetalj.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 601884
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/JPEG", null, null);		// Test [23] <- Index 23
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0024 = "broderamera.nu";
		int    requestPort0024 = 443;
		String requestFile0024 = "/wp-content/uploads/2015/06/BroderaMeralogga.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 180733
		// content test algorithm: none - no content check
		...
		String requestHost0025 = "broderamera.nu";
		int    requestPort0025 = 443;
		String requestFile0025 = "/wp-content/themes/Divi/fonts/ETmodules_v2.ttf";
		...
		// verify response: status code = 200, content type = "APPLICATION/X-FONT-TTF", header text fragment = [verification disabled], recorded content size = 103612
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/X-FONT-TTF", null, null);		// Test [25] <- Index 25
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0026 = "detectportal.firefox.com";
		int    requestPort0026 = 80;
		String requestFile0026 = "/success.txt";
		...
		// verify response: status code = 200, content type = "TEXT/PLAIN", header text fragment = [verification disabled], recorded content size = 8
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/PLAIN", null, null);		// Test [26] <- Index 26
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0028 = "127.0.0.1";
		int    requestPort0028 = 7990;
		String requestFile0028 = "/dfischer/webadmininterface/BrowserExtensionWeblet" +
				"?action=getRecordState";
	...
	boolean executePage_2(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0030 = "127.0.0.1";
		int    requestPort0030 = 7990;
		String requestFile0030 = "/dfischer/webadmininterface/BrowserExtensionWeblet" +
				"?action=getRecordState";
		...
		String requestHost0031 = "127.0.0.1";
		int    requestPort0031 = 7990;
		String requestFile0031 = "/dfischer/webadmininterface/BrowserExtensionWeblet" +
				"?action=getRecordState";
		...
		log();
		log("# title: Allmoge | Brodera Mera");
		String requestProt0032 = "https";
		String requestHost0032 = "broderamera.nu";
		int    requestPort0032 = 443;
		String requestFile0032 = "/allmoge/";
		...
		// verify response: status code = 200, content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 25527
		// content test algorithm: none - no content check
		...
		String requestHost0033 = "broderamera.nu";
		int    requestPort0033 = 80;
		String requestFile0033 = "/wp-content/uploads/2015/06/Carinas-kudde-1-150x149.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 15519
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/JPEG", null, null);		// Test [33] <- Index 33
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0034 = "detectportal.firefox.com";
		int    requestPort0034 = 80;
		String requestFile0034 = "/success.txt";
		...
		// verify response: status code = 200, content type = "TEXT/PLAIN", header text fragment = [verification disabled], recorded content size = 8
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/PLAIN", null, null);		// Test [34] <- Index 34
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0035 = "broderamera.nu";
		int    requestPort0035 = 80;
		String requestFile0035 = "/wp-content/uploads/2015/06/Tegelkudde-1-150x150.jpg";
		...
		String requestHost0036 = "broderamera.nu";
		int    requestPort0036 = 80;
		String requestFile0036 = "/wp-content/uploads/2015/06/Tulpandyna-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 16406
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/JPEG", null, null);		// Test [36] <- Index 36
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0037 = "broderamera.nu";
		int    requestPort0037 = 80;
		String requestFile0037 = "/wp-content/uploads/2015/10/Zickermankudde-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 15814
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/JPEG", null, null);		// Test [37] <- Index 37
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0038 = "broderamera.nu";
		int    requestPort0038 = 80;
		String requestFile0038 = "/wp-content/uploads/2015/06/Varfaglar-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 13318
		// content test algorithm: none - no content check
		...
		String requestHost0039 = "broderamera.nu";
		int    requestPort0039 = 80;
		String requestFile0039 = "/wp-content/uploads/2015/06/Folklivskudde-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 12848
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/JPEG", null, null);		// Test [39] <- Index 39
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0040 = "broderamera.nu";
		int    requestPort0040 = 80;
		String requestFile0040 = "/wp-content/uploads/2015/06/Vepa-och-kudde-rolakan-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 12915
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/JPEG", null, null);		// Test [40] <- Index 40
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0041 = "broderamera.nu";
		int    requestPort0041 = 80;
		String requestFile0041 = "/wp-content/uploads/2015/06/Tivstomskudde-Valknut-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 13917
		// content test algorithm: none - no content check
		...
		String requestHost0042 = "broderamera.nu";
		int    requestPort0042 = 80;
		String requestFile0042 = "/wp-content/uploads/2015/06/Liten-kudde-med-Dala-Floda-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 9324
		// content test algorithm: none - no content check
		...
		String requestHost0043 = "broderamera.nu";
		int    requestPort0043 = 80;
		String requestFile0043 = "/wp-content/uploads/2015/10/Smalandskudde-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 14990
		// content test algorithm: none - no content check
		...
		String requestHost0044 = "broderamera.nu";
		int    requestPort0044 = 80;
		String requestFile0044 = "/wp-content/uploads/2015/06/Vepa-Livets-gang-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 14897
		// content test algorithm: none - no content check
		...
		String requestHost0045 = "broderamera.nu";
		int    requestPort0045 = 80;
		String requestFile0045 = "/wp-content/uploads/2015/09/varmlandskuddar-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 12961
		// content test algorithm: none - no content check
		...
		String requestHost0046 = "broderamera.nu";
		int    requestPort0046 = 80;
		String requestFile0046 = "/wp-content/uploads/2015/09/Fyrkant-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 13999
		// content test algorithm: none - no content check
		...
		String requestHost0047 = "broderamera.nu";
		int    requestPort0047 = 80;
		String requestFile0047 = "/wp-content/uploads/2015/06/Ahuskudde2-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 11659
		// content test algorithm: none - no content check
		...
		String requestHost0048 = "broderamera.nu";
		int    requestPort0048 = 80;
		String requestFile0048 = "/wp-content/uploads/2016/09/Kudde-fran-Ratan-1-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 10520
		// content test algorithm: none - no content check
		...
		String requestHost0049 = "broderamera.nu";
		int    requestPort0049 = 80;
		String requestFile0049 = "/wp-content/uploads/2015/06/Frosokudde3-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 15284
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/JPEG", null, null);		// Test [49] <- Index 49
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
	...
	boolean executePage_2_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0050 = "broderamera.nu";
		int    requestPort0050 = 80;
		String requestFile0050 = "/wp-content/uploads/2015/11/Glasunderlagg1-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 9973
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/JPEG", null, null);		// Test [50] <- Index 50
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0051 = "broderamera.nu";
		int    requestPort0051 = 80;
		String requestFile0051 = "/wp-content/uploads/2015/10/Fagelkudde-150x150.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 14273
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/JPEG", null, null);		// Test [51] <- Index 51
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0052 = "detectportal.firefox.com";
		int    requestPort0052 = 80;
		String requestFile0052 = "/success.txt";
		...
		String requestHost0053 = "127.0.0.1";
		int    requestPort0053 = 7990;
		String requestFile0053 = "/dfischer/webadmininterface/BrowserExtensionWeblet" +
				"?action=getRecordState";
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("Broderamera", concurrentUsers);
		...
		performanceData.setInfoText("Broderamera");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				Broderamera simulatedUser = new Broderamera(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

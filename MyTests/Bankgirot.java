...
public class Bankgirot extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "BankgirotExtParams.dat";             // input file name for very large parameter values
	 ...
	 */
	public Bankgirot(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	private boolean execute(int totalLoopCounter) throws Exception
	{
		...
		log();
		log();
		log("# Page #2: Another page");
		log("# ---------------------");
		threadStep = setPageBreak(performanceData, threadStep, "Page #2: Another page", 3000, 35, -1);		// hint: param #4 is the user's think time in milliseconds, param #5 is randomness of the user's think time in percent (+/- 0..100%), param #6 is the maximum acceptable response time in milliseconds (-1 = not configured)
		pageThreadHandler = new HttpTestURLThreadHandler(threadStep - 1, maxParallelThreadsPerUser, performanceData, this);   // support for parallel processing of http(s) requests within a page. hint: param #2 is the number of parallel threads per user
		log();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0001 = "detectportal.firefox.com";
		int    requestPort0001 = 80;
		String requestFile0001 = "/success.txt";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/PLAIN", null, 8, 5);		// Test [1] <- Index 1
		if (!urlCallPassed)
		{
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/HTML", null, 3, 5);		// Test [2] <- Index 2
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0003 = "127.0.0.1";
		int    requestPort0003 = 7990;
		String requestFile0003 = "/dfischer/webadmininterface/BrowserExtensionWeblet" +
				"?action=getRecordState";
		...
		// verify response: status code = 200, content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 3
		// content test algorithm: check size +/- 5%, defined content size = 3
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/HTML", null, 3, 5);		// Test [3] <- Index 3
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		log();
		log("# title: Bankgirot - Start - Bankgirot.se");
		String requestProt0004 = "http";
		String requestHost0004 = "bankgirot.se";
		...
		// verify response: status code = 200, content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 33533
		// content test algorithm: search text
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/HTML", null, "Sverige betalar med ny och digital teknik");		// Test [4] <- Index 4
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0005 = "bankgirot.se";
		int    requestPort0005 = 80;
		String requestFile0005 = "/Frontend/build/stylesheets/app.css";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 41727
		// content test algorithm: check size +/- 5%, defined content size = 41727
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 41727, 5);		// Test [5] <- Index 5
		if (!urlCallPassed)
		{
		...
		String requestHost0006 = "bankgirot.se";
		int    requestPort0006 = 80;
		String requestFile0006 = "/Frontend/static/custom.modernizr.js";
		...
		// content test algorithm: check size +/- 5%, defined content size = 9287
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 9287, 5);		// Test [6] <- Index 6
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0007 = "bankgirot.se";
		int    requestPort0007 = 80;
		String requestFile0007 = "/Frontend/build/javascripts/app.js";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 2137058
		// content test algorithm: check size +/- 5%, defined content size = 2137058
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 2137058, 5);		// Test [7] <- Index 7
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0008 = "bankgirot.se";
		int    requestPort0008 = 80;
		String requestFile0008 = "/Content/images/bankgirot-logo.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 11057
		// content test algorithm: check size +/- 5%, defined content size = 11057
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 11057, 5);		// Test [8] <- Index 8
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0009 = "bankgirot.se";
		int    requestPort0009 = 80;
		String requestFile0009 = "/Content/images/bankgirot-logo-white.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 8144
		// content test algorithm: check size +/- 5%, defined content size = 8144
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 8144, 5);		// Test [9] <- Index 9
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0010 = "bankgirot.se";
		...
		// verify response: status code = 200, content type = "IMAGE/X-ICON", header text fragment = [verification disabled], recorded content size = 1469
		// content test algorithm: check size +/- 5%, defined content size = 1469
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/X-ICON", null, 1469, 5);		// Test [10] <- Index 10
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0011 = "bankgirot.se";
		int    requestPort0011 = 80;
		String requestFile0011 = "/Frontend/build/webfonts/font/DINPro-Regular.otf";
		...
		// verify response: status code = 200, content type = "FONT/OTF", header text fragment = [verification disabled], recorded content size = 81840
		// content test algorithm: check size +/- 5%, defined content size = 81840
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "FONT/OTF", null, 81840, 5);		// Test [11] <- Index 11
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0012 = "bankgirot.se";
		int    requestPort0012 = 80;
		String requestFile0012 = "/globalassets/bilder/sajtbakgrunder/bg-rullband.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 850285
		// content test algorithm: check size +/- 5%, defined content size = 850285
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 850285, 5);		// Test [12] <- Index 12
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0013 = "bankgirot.se";
		int    requestPort0013 = 80;
		String requestFile0013 = "/globalassets/bilder/toppbanner_start/bg_montage_varlden_824x342.gif";
		...
		// verify response: status code = 200, content type = "IMAGE/GIF", header text fragment = [verification disabled], recorded content size = 177545
		// content test algorithm: check size +/- 5%, defined content size = 177545
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/GIF", null, 177545, 5);		// Test [13] <- Index 13
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0014 = "bankgirot.se";
		int    requestPort0014 = 80;
		String requestFile0014 = "/Frontend/build/webfonts/font/DINPro-Medium.otf";
		...
		// verify response: status code = 200, content type = "FONT/OTF", header text fragment = [verification disabled], recorded content size = 83628
		// content test algorithm: check size +/- 5%, defined content size = 83628
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "FONT/OTF", null, 83628, 5);		// Test [14] <- Index 14
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0015 = "bankgirot.se";
		int    requestPort0015 = 80;
		String requestFile0015 = "/Frontend/build/webfonts/font/fontello.woff" +
				"?45316902";
		...
		// verify response: status code = 200, content type = "FONT/X-WOFF", header text fragment = [verification disabled], recorded content size = 7020
		// content test algorithm: check size +/- 5%, defined content size = 7020
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "FONT/X-WOFF", null, 7020, 5);		// Test [15] <- Index 15
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0016 = "bankgirot.se";
		int    requestPort0016 = 80;
		String requestFile0016 = "/Frontend/build/webfonts/font/OCRATributeCom-Regular.ttf";
		...
		// verify response: status code = 200, content type = "APPLICATION/OCTET-STREAM", header text fragment = [verification disabled], recorded content size = 177904
		// content test algorithm: check size +/- 5%, defined content size = 177904
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/OCTET-STREAM", null, 177904, 5);		// Test [16] <- Index 16
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0017 = "detectportal.firefox.com";
		int    requestPort0017 = 80;
		String requestFile0017 = "/success.txt";
		...
		// verify response: status code = 200, content type = "TEXT/PLAIN", header text fragment = [verification disabled], recorded content size = 8
		// content test algorithm: check size +/- 5%, defined content size = 8
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/PLAIN", null, 8, 5);		// Test [17] <- Index 17
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0018 = "www.googletagmanager.com";
		int    requestPort0018 = 80;
		String requestFile0018 = "/gtm.js" +
				"?id=GTM-P7LNJ5";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 19222
		// content test algorithm: check size +/- 5%, defined content size = 19222
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 19222, 5);		// Test [18] <- Index 18
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0019 = "detectportal.firefox.com";
		int    requestPort0019 = 80;
		String requestFile0019 = "/success.txt";
		...
		// verify response: status code = 200, content type = "TEXT/PLAIN", header text fragment = [verification disabled], recorded content size = 8
		// content test algorithm: check size +/- 5%, defined content size = 8
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/PLAIN", null, 8, 5);		// Test [19] <- Index 19
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0020 = "127.0.0.1";
		int    requestPort0020 = 7990;
		String requestFile0020 = "/dfischer/webadmininterface/BrowserExtensionWeblet" +
				"?action=getRecordState";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/HTML", null, 4, 5);		// Test [20] <- Index 20
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
	...
	boolean executePage_1_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0021 = "127.0.0.1";
		int    requestPort0021 = 7990;
		String requestFile0021 = "/dfischer/webadmininterface/BrowserExtensionWeblet" +
				"?action=getRecordState";
		...
		// verify response: status code = 200, content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 4
		// content test algorithm: check size +/- 5%, defined content size = 4
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/HTML", null, 4, 5);		// Test [21] <- Index 21
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0022 = "detectportal.firefox.com";
		int    requestPort0022 = 80;
		String requestFile0022 = "/success.txt";
		...
		// verify response: status code = 200, content type = "TEXT/PLAIN", header text fragment = [verification disabled], recorded content size = 8
		// content test algorithm: check size +/- 5%, defined content size = 8
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/PLAIN", null, 8, 5);		// Test [22] <- Index 22
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
	...
	boolean executePage_2(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0024 = "127.0.0.1";
		int    requestPort0024 = 7990;
		String requestFile0024 = "/dfischer/webadmininterface/BrowserExtensionWeblet" +
				"?action=getRecordState";
		...
		// verify response: status code = 200, content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 4
		// content test algorithm: check size +/- 5%, defined content size = 4
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/HTML", null, 4, 5);		// Test [24] <- Index 24
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		log();
		log("# title: Manuella betalningar via Bankgirot - Bankgirot");
		String requestProt0026 = "http";
		String requestHost0026 = "bankgirot.se";
		int    requestPort0026 = 80;
		String requestFile0026 = "/tjanster/utbetalningar/manuella-betalningar/";
		...
		// verify response: status code = 200, content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 23736
		// content test algorithm: search text
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/HTML", null, "Manuella betalningar via Bankgirot - Bankgirot");		// Test [26] <- Index 26
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0027 = "bankgirot.se";
		int    requestPort0027 = 80;
		String requestFile0027 = "/link/7d00f786f0bb48bdabff34b6f1930e37.aspx" +
				"?id=1818" +
				"&epslanguage=sv";
		...
		// verify response: status code = 301, content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 193
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {301}, null, null, null);		// Test [27] <- Index 27
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0028 = "bankgirot.se";
		int    requestPort0028 = 80;
		String requestFile0028 = "/globalassets/bilder/toppbanner/top-banner-16.jpg";
		...
		// verify response: status code = 200, content type = "IMAGE/JPEG", header text fragment = [verification disabled], recorded content size = 47546
		// content test algorithm: check size +/- 5%, defined content size = 47546
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/JPEG", null, 47546, 5);		// Test [28] <- Index 28
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0029 = "detectportal.firefox.com";
		int    requestPort0029 = 80;
		String requestFile0029 = "/success.txt";
		...
		// verify response: status code = 200, content type = "TEXT/PLAIN", header text fragment = [verification disabled], recorded content size = 8
		// content test algorithm: check size +/- 5%, defined content size = 8
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/PLAIN", null, 8, 5);		// Test [29] <- Index 29
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0030 = "detectportal.firefox.com";
		int    requestPort0030 = 80;
		String requestFile0030 = "/success.txt";
		...
		// verify response: status code = 200, content type = "TEXT/PLAIN", header text fragment = [verification disabled], recorded content size = 8
		// content test algorithm: check size +/- 5%, defined content size = 8
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/PLAIN", null, 8, 5);		// Test [30] <- Index 30
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		// verify response: status code = 200, content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 4
		// content test algorithm: check size +/- 5%, defined content size = 4
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/HTML", null, 4, 5);		// Test [31] <- Index 31
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
	...
	public static void main(String[] args)
	{
		...
		final int MAX_THREAD_STEPS = 30;  // number of URL requests in execute() - modify this value if you add or delete some requests
		...
		performanceData.setInfoText("Bankgirot");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				Bankgirot simulatedUser = new Bankgirot(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
